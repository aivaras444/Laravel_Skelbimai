        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 px-2 flex items-center">
                    <a href="{{ route('skelbimai.index')}}">Sklebimai</a>
                </div>
                <div class="shrink-0 px-2 flex items-center">
                    <a href="{{ route('skelbimai.create')}}">Įdėti sklebimą</a>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @if (Route::has('login') && Auth::check())
                    <div class="shrink-0 px-2 flex items-center">
                        <a href="{{ route('isiminti.index')}}">Įsiminti</a>
                    </div>
                    <div class="shrink-0 px-2 flex items-center">
                        <a href="{{ route('skelbimai.manoSkelbimai')}}">Mano skelbimai</a>
                    </div>
